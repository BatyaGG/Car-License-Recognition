...
This is just a toy project for getting used to OpenCV and Tesseract by application to real world problem. Lots of robust and accurate solutions already exists with extensive usage of deep learning techniques for license plate detection and recognition.
